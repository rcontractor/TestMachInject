...
int main(int argc, const char * argv[])
{
  @autoreleasepool {
    ...
    launch_data_t machPortData = launch_data_dict_lookup(machs, "com.ruchi.TestMachInject.Installer.mach");
    ...
    FEFrameworkInstaller *installer = [FEFrameworkInstaller new];
